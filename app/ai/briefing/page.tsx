       ...
       <main className="flex-1 w-full max-w-5xl mx-auto px-4 md:px-8 py-8 md:py-12">
          ...
          <div className="bg-white rounded-[2.5rem] shadow-2xl border border-gray-100 overflow-hidden relative">
             ...
             <div className="absolute inset-0 pointer-events-none flex items-center justify-center opacity-[0.02] rotate-[-35deg] scale-150 select-none">
                <span className="text-[12rem] font-black tracking-tighter">CONFIDENTIAL</span>
             </div>
             ...
             <div className="p-8 md:p-16 space-y-12 relative z-10">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start gap-8 border-b border-gray-50 pb-10">
                   <div className="flex gap-6">
                      ...
                      <div className="flex flex-col uppercase">
                         <h1 className="text-3xl font-black text-zinc-900 italic tracking-tighter leading-none mb-2">INTELLIGENCE BRIEFING</h1>
                         <div className="flex items-center gap-3">
                            <span className="text-[9px] font-black px-1.5 py-0.5 bg-red-100 text-red-600 rounded">RESTRICTED</span>
                   ...
                   <div className="flex flex-col items-start md:items-end text-right">
                      <span className="text-[9px] font-black text-gray-400 uppercase tracking-widest leading-none mb-1">Generated By</span>
                ...
                <section className="space-y-6">
                   <div className="flex items-center gap-3 border-b-2 border-orange-500/10 pb-4">
                      ...
                      <h2 className="text-sm font-black text-zinc-900 italic uppercase underline decoration-orange-500 decoration-2 underline-offset-4">EXECUTIVE SUMMARY</h2>
                   </div>
                ...
                <section className="space-y-6">
                   <div className="flex items-center gap-3 border-b-2 border-red-500/10 pb-4">
                      ...
                      <h2 className="text-sm font-black text-zinc-900 italic uppercase">IMMEDIATE THREATS</h2>
                   </div>
                ...
                <section className="space-y-6">
                   <div className="flex items-center gap-3 border-b-2 border-slate-500/10 pb-4">
                      ...
                      <h2 className="text-sm font-black text-zinc-900 italic uppercase">AFFECTED INFRASTRUCTURE</h2>
                   </div>
                ...
                <section className="space-y-6">
                   <div className="flex items-center gap-3 border-b-2 border-green-500/10 pb-4">
                      ...
                      <h2 className="text-sm font-black text-zinc-900 italic uppercase">RECOMMENDED ACTIONS</h2>
                   </div>
