...
export default function QuickActionCard({
  ...
  return (
    <button
      onClick={onClick}
      className={cn(
        "group relative overflow-hidden bg-white border border-gray-100 rounded-2xl p-6 text-left transition-all hover:shadow-xl hover:border-brand-red/20 active:scale-[0.98]",
        className
      )}
    >
      {BgIcon && (
